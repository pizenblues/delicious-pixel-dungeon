...
public class DM100 extends MobSprite {
	...
	public void zap( int pos ) {
		...
		if (enemy != null) {
			parent.add(new Lightning(origin, enemy.sprite.destinationCenter(), (OrcSorcerer) ch));
		} else {
			parent.add(new Lightning(origin, pos, (OrcSorcerer) ch));
		}
