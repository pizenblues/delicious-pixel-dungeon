...
public abstract class OrcSorcererSprite extends MobSprite {
	
	protected int boltType;
	
	protected abstract int texOffset();
	
	public OrcSorcererSprite() {
		super();
	...
	public static class Red extends OrcSorcererSprite {
		{
	...
	public static class Blue extends OrcSorcererSprite {
		{
	...
	public static class Purple extends OrcSorcererSprite {
		{
