...
public class WndTabbedBag extends Window {
    ...
    public WndTabbedBag() {
        super( 0, 0, Chrome.get( Chrome.Type.TABAG_SET ) );
    ...
    protected class Tab extends Button {
        ...
        protected void select( boolean value ) {
            ...
            bg = Chrome.get( selected ?
                    Chrome.Type.TABAG_SELECTED :
                    Chrome.Type.TABAG_UNSELECTED );
            addToBack( bg );
        ...
        protected void onClick() {
            if (!selected) {
                ...
                WndTabbedBag.this.onClick(this);
            }
        }
    }
