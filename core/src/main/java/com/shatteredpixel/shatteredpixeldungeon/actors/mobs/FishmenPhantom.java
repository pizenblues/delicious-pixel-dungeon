...
import com.shatteredpixel.shatteredpixeldungeon.sprites.FishmenPhantomSprite;
...
public class FishmenPhantom extends Fishmen {

	{
		spriteClass = FishmenPhantomSprite.class;
