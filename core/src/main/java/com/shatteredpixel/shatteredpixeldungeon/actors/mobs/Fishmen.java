...
import com.shatteredpixel.shatteredpixeldungeon.sprites.FishmenSprite;
import com.watabou.utils.PathFinder;
import com.watabou.utils.Random;

public class Fishmen extends Mob {
	
	{
		spriteClass = FishmenSprite.class;
	...
	public static Fishmen random(){
		float altChance = 1/50f * RatSkull.exoticChanceMultiplier();
		if (Random.Float() < altChance){
			return new FishmenPhantom();
		} else {
			return new Fishmen();
		}
	}
