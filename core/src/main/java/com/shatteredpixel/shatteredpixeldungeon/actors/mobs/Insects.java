...
import com.shatteredpixel.shatteredpixeldungeon.sprites.InsectsSprite;
import com.watabou.utils.Bundle;
import com.watabou.utils.Random;

import java.util.ArrayList;

public class Insects extends Mob {

	{
		spriteClass = InsectsSprite.class;
	...
	private Insects split() {
		Insects clone = new Insects();
